...
class BSAArchive(BaseArchive):
    """BSAArchive for version 105 of BSA files.

    Note:
        - Used by Skyrim: Special Edition
    """
    ...
    def can_handle(cls, filepath: str) -> bool:
        ...
        return header.magic == b"BSA\x00" and header.version == 105
    ...
    def iter_files(self) -> Generator[ArchiveFile, None, None]:
        ...
        uncompressed_file_struct = Struct("data" / GreedyBytes)
        compressed_file_struct = Struct(
            "original_size" / Int32ul, "data" / LZ4CompressedAdapter(GreedyBytes)
        )
