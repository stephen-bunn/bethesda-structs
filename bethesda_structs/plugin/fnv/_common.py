...
from .._common import (FormID, SubrecordCollection, Subrecord,)
...
DestructionCollection = SubrecordCollection([
    ...
    SubrecordCollection([
        ...
        Subrecord('DMDL', CString('utf8') * 'Stage Model Filename', optional=True),
        Subrecord('DMDT', GreedyBytes * 'Stage Model Texture File Hashes', optional=True),
...
ModelCollection = SubrecordCollection([
    ...
    ) * 'Alternate Textures', optional=True),
    Subrecord('MODD', FlagsEnum(
        Int8ul,
        head=0x01,
        torso=0x02,
        right_hand=0x04,
        left_hand=0x08
    ) * 'Facegen Model Flags', optional=True)
])
