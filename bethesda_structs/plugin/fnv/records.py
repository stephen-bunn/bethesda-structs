...
from .._common import (
    RecordSubrecords, SubrecordCollection, SubrecordStructure,
)
from ._common import (
    ObjectBoundsStruct,
)
...
TES4_Subrecords = RecordSubrecords([
    SubrecordStructure('HEDR', Struct(
        "version" / Float32l,
        "num_records" / Int32ul,
        "next_object_id" / Int32ul
    ) * 'Header'),
    SubrecordStructure('CNAM', CString('utf8') * 'Author'),
    SubrecordStructure('SNAM', CString('utf8') * 'Description', optional=True),
    SubrecordCollection([
